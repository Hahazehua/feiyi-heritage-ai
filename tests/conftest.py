...
def block_real_deepseek(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setenv("OPENAI_IMAGE_API_KEY", "your_openai_api_key_here")
    ...
    monkeypatch.setattr("openai.resources.images.Images.generate", fail_network)
    monkeypatch.setattr("openai.resources.images.Images.edit", fail_network)
